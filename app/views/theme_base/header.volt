<header>
    <nav class="navbar app-navbar navbar-fixed-top">
            <div class="navbar-header">
                ...
                <a href="<?php echo $this->url->get('');?>" class="app-a" title="Ir a Inicio"><img src="<?php echo $this->url->get('').'img/logo_positive.svg'; ?>" alt="Logo" class="img-responsive app-logo"></a>
            </div>
