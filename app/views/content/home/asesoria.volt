    ...
    <div class="container-fluid app-background-content">
        <div class="row">
              ...
              <div class="col-xs-12 col-sm-4"><br>
                    <h1 class="app-titulo-home-left">¿SOY SUJETO DE CRÉDITO?</h1>
                    <h1 class="app-titulo-home-left">...¿SUJETO DE CONFIANZA?</h1>
              </div>            
          		<div class="col-xs-12 col-sm-4 app-align-center">
            				<img src="<?php echo $this->url->get("").'img/asesoria/Logo.png'; ?>" class="img-responsive app-img-edu-logo2" alt=""> 
              </div>
